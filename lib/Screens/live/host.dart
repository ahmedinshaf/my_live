...
import 'package:flutter_auth/utils/setting.dart';
            ...
            Container(
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: <Color>[Color(0xff00FFF7), Colors.blue],
                  ),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          '$userNo',
                          style:
                              TextStyle(color: Color(0xff00FFF7), fontSize: 11),
                        ),
                      ],
                    ),
                  )),
            ...
            new Expanded(
              ...
              child: new TextField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    hintText: 'Comment',
                    hintStyle: TextStyle(color: Color(0xff00FFF7)),
                    enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(50.0),
                        borderSide: BorderSide(color: Color(0xff00FFF7))),
